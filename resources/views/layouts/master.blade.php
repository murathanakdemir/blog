...
<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
    <div class="continer-fluid" id="topbar">
        <div class="row">
            <div class="col-md-12">
                <ul>
                    <li><a href="/"><i class="fa fa-home" aria-hidden="true"></i> Anasayfa</a></li>
                    @if(Auth::guest())
                    <li><a href="/register"><i class="fa fa-users uyelik-tus"></i> Üye Ol</a></li>
                    <li><a href="/login"><i class="fa fa-sign-in uyelik-tus"></i> Üye Girişi</a></li>
                    @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="{{url('/user')}}"><i class="fa fa-btn fa-user"></i>Kullancılar</a></li>
                            ...
                            @endif
                            <li><a href="{{url('/logout')}}"><i class="fa fa-btn fa-sign-out"></i>Güvenli Çıkış</a></li>
                        </ul>
                    </li>
                    @endif
                </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <p class="copyright text-muted">Copyright &copy; {!! config("ayarlar.author") !!}</p>
            </div>
        </div>
    </div>
</footer>
